...
- **The Knowledge Log:** Every synthesis session MUST be recorded in `_SYS/log.md`. Use `mcp__obsidian-vault-mcp__obsidian_insert_at_heading` to append logs under a relevant heading.
