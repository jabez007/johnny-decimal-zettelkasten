...
- **Tool Usage:** When interacting with the Obsidian vault, you MUST use the tools prefixed with `mcp__obsidian-vault-mcp__` (e.g., use `mcp__obsidian-vault-mcp__obsidian_create_note` instead of `obsidian_create_note`).
