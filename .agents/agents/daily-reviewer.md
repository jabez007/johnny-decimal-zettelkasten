...
- **Tool Usage:** When interacting with the Obsidian vault, you MUST use the tools prefixed with `{{MCP_PREFIX}}` (e.g., use `{{MCP_PREFIX}}obsidian_create_note` instead of `obsidian_create_note`).
