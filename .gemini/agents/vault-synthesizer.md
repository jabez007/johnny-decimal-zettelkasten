...
- **The Knowledge Log:** Every synthesis session MUST be recorded in `_SYS/log.md`. Use `mcp_obsidian-vault-mcp_obsidian_insert_at_heading` to append logs under a relevant heading.
